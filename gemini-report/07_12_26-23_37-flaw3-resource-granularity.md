...
## 涉及的核心文件与类型
- **全局共享设定**：`Apps/EgakiumMac/Sources/CoworkProjectSettings.swift`
- **单根限制设计**：`Packages/EgakiumTools/Sources/PathConfinement.swift`
- **准入控制**：`Packages/EgakiumCowork/Sources/Orchestrator.swift` 中的 `attach(_:)`
