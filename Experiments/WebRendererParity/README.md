...
- it has no bridge to Egakium sessions, EventLog, credentials, tools, leases,
  or permissions.
...
```sh
cd /Users/vita/Vitemis/Egakium/Experiments/WebRendererParity
npm ci
npm test
npm run licenses
npm run build
...
message contents, parser instances, browser state, credentials, or Egakium
data.
