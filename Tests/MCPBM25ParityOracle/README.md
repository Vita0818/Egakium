...
It is a developer verification fixture only. It is not linked into Egakium,
...
Run from the Egakium repository root:

```sh
CARGO_TARGET_DIR=/private/tmp/egakium-mcp-bm25-oracle-target \
cargo fetch --locked \
...
`Packages/EgakiumMCP/Tests/MCPBM25CodexParityTests.swift`:
