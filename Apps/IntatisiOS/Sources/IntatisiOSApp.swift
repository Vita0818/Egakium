            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                Section("Configuration") {
                    Button {
                        ...
                        Label("Import Ekagium Config", systemImage: "square.and.arrow.down")
                    }
                    ...
                    Text("Import an Ekagium JSON or JSONC file from Files. Provider and model settings are stored in this app; literal credentials are migrated to the protected auth file.")
                        .font(captionFont)
                        .foregroundStyle(.secondary)
