...
enum WorkspaceAccess {
    ...
    private static let bookmarkStoreKey = "egakium.workspace.bookmarks"

    private static func sessionBookmarkKey(_ session: SessionID) -> String {
        "egakium.workspace.sessionBookmark.\(session.rawValue)"
    }

    private static func sessionPathKey(_ session: SessionID) -> String {
        "egakium.workspace.sessionPath.\(session.rawValue)"
    }
