...
enum AppConfig {
    ...
    private static let baseURLKey = "egakium.baseURL"
    private static let modelKey = "egakium.model"
    private static let providerCatalogKey = "egakium.providerCatalog.v1"
    private static let providerSelectionKey = "egakium.providerSelection.v1"
    private static let configEnvKey = "EGAKIUM_CONFIG"
    ...
    static func prepareEditableConfigFile() throws -> URL {
        ...
        do {
            ...
            let fallback = appSupportDir().appendingPathComponent("egakium.json")
    ...
    static func appSupportDir() -> URL {
        ...
        return base.appendingPathComponent("Egakium", isDirectory: true)
    }
    ...
    private static func configFileCandidates() -> [URL] {
        ...
        let userConfigDir = home
            .appendingPathComponent(".config/egakium", isDirectory: true)
        return [
            userConfigDir.appendingPathComponent("egakium.json"),
            userConfigDir.appendingPathComponent("egakium.jsonc"),
            appSupportDir().appendingPathComponent("egakium.json"),
            appSupportDir().appendingPathComponent("egakium.jsonc"),
    ...
    private static func preferredConfigFileURL() -> URL {
        ...
        return FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent(".config/egakium/egakium.json")
    }

    private static func isModernConfigFile(_ url: URL) -> Bool {
        switch url.lastPathComponent {
        case "egakium.json", "egakium.jsonc":
            return true
        default:
            return false
        }
