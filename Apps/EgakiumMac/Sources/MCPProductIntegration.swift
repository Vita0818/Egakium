...
struct EgakiumMCPSettingsView: View {
    ...
    private func exportCatalog() {
        ...
        EgakiumMacProcessDiagnostics.shared
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            case (.macDeveloperID, .stdio),
                ...
                guidanceStep(
                    1,
                    "Install the MCP server using its trusted publisher's instructions outside Egakium.")
                guidanceStep(
                    2,
            ...
            case (.linuxCLI, .stdio):
                ...
                guidanceStep(
                    2,
                    "Run egakium mcp doctor and resolve every bwrap or launch-artifact error.")
                guidanceStep(
                    3,
