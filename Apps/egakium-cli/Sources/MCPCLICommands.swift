...
enum MCPCLIError:
    ...
    var errorDescription: String? {
        switch self {
        case .missingSubcommand:
            return "missing MCP subcommand; run `egakium mcp help`"
...
func printMCPHelp() {
    out("""
    Egakium external MCP client

    INVENTORY
      egakium mcp list [--json]
      egakium mcp get --server <alias|id> [--json]
      egakium mcp add --alias <id> --name <name> (--url <https> | --command </absolute/path>) [configuration options] [--yes] [--json]
      egakium mcp edit --server <alias|id> [same mutable fields]
      egakium mcp duplicate --server <alias|id> --alias <new>
      egakium mcp enable|disable --server <alias|id>
      egakium mcp remove --server <alias|id> --yes
      egakium mcp test --server <alias|id>
      egakium mcp doctor [--json]
      egakium mcp import --file <explicit.json> [--format mcp-json|claude-json] [explicit launch-closure flags] [--replace-conflicts] [--allow-insecure-loopback-development-http]
      egakium mcp export [--file <path>] [--include-disabled]
    ...
    SESSION AUTHORITY
      ...
      egakium mcp auth logout --server <alias|id> [--yes]

    LIVE SESSION OWNER
      egakium mcp status [--session <id>] [--agent <id>] [--json]
      egakium mcp connect --session <id> --agent <id> [--task <id>] [--server <alias|id>] --yes
      egakium mcp inspect|tools|resources|prompts --session <id> --agent <id> [--task <id>] [--server <alias|id>] --yes
      egakium mcp refresh|disconnect --session <id> --agent <id> [--task <id>] [--server <alias|id>]
      egakium mcp reload [--json]
