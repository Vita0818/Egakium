    ...
    XCTestCase
{
        ...
        throws
    {
        ...
        let root = FileManager.default
            .temporaryDirectory
            .appendingPathComponent(
                "egakium-cli-shipping-stdout-\(UUID().uuidString)",
                isDirectory: true)
        ...
        environment["EGAKIUM_CONFIG"] =
            configURL.path
        environment["EGAKIUM_API_KEY"] =
            "shipping-cli-test-key"
        environment["EGAKIUM_MODEL"] =
            "test/cli-no-mcp-model"
        environment["EGAKIUM_MODE"] = "code"
        environment["EGAKIUM_USAGE"] = "0"
        ...
        XCTAssertTrue(stdout.contains("Egakium"))
        ...
        async throws
    {
        ...
        let root = FileManager.default
            .temporaryDirectory
            .appendingPathComponent(
                "egakium-cli-mcp-owner-\(UUID().uuidString)",
                isDirectory: true)
        let workspace = root.appendingPathComponent(
            "workspace",
            isDirectory: true)
    ...
    private static func makeHostFixture(
        ...
        let root = FileManager.default
            .temporaryDirectory
            .appendingPathComponent(
                "egakium-cli-host-\(name)-\(UUID().uuidString)",
                isDirectory: true)
        let workspace = root.appendingPathComponent(
            "workspace",
            isDirectory: true)
        ...
        throws -> URL
    {
        ...
        throw XCTSkip(
            "The built shipping egakium executable is unavailable.")
    }
}
...
private final class MCPCLILoopbackFixture {
    ...
    init() throws {
        statsURL = FileManager.default
            .temporaryDirectory
            .appendingPathComponent(
                "egakium-cli-mcp-stats-\(UUID().uuidString).log")
