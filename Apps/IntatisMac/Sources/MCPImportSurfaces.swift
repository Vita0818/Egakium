            ...
            ForEach(
                ...
                VStack(alignment: .leading, spacing: 5) {
                    ...
                    case .stdio(let stdio):
                        ...
                        Text(
                            "Declare the complete launch closure explicitly: exactly one executable plus every interpreter, script, package entrypoint, lockfile, and helper. Ekagium does not infer files from imported arguments.")
                            .font(.caption)
                            .foregroundStyle(.secondary)
                        #endif
                    }
