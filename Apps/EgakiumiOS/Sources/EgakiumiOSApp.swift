            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                Section("Configuration") {
                    Button {
                        ...
                        Label("Import Egakium Config", systemImage: "square.and.arrow.down")
                    }
                    ...
                    Text("Import an Egakium JSON or JSONC file from Files. Provider and model settings are stored in this app; literal credentials are migrated to the protected auth file.")
                        .font(captionFont)
                        .foregroundStyle(.secondary)
...
@main
struct EgakiumiOSApp {
    static func main() {
        print("EgakiumiOS is an iOS SwiftUI app and only runs on iOS.")
    }
}
#endif
