...
//
//  Egakium derivative modification: native TextKit 2 inline-math attachments.
//
...
/// Dedicated attachment type for Egakium inline and display mathematics.
///
...
final class InlineMathAttachment: NSTextAttachment {
  static let mimeType = "application/vnd.vita0818.egakium-inline-math+json"
  ...
  /// TextKit 2 path available in package-test hosts that do not export Egakium's
...
///
/// Production uses the exact dynamic UTI derived from Egakium's unique MIME
