...
final class PathConfinementTests: XCTestCase {
    ...
    private func tempWorkspace() throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("egakium-path-\(UUID().uuidString)", isDirectory: true)
    ...
    func testAgentConfigSecretPathsDenied() throws {
        ...
        XCTAssertThrowsError(try PathConfinement.resolve("~/.config/egakium/config.json", within: root))
