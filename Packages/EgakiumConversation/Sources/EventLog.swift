...
public enum EventLogError: Error, Equatable, LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        ...
        case .lockTimedOut:
            return "The session event log is busy in another Egakium operation."
        case .writerAlreadyActive:
            return "Another Egakium runtime is already writing this session."
        ...
        case .unsupportedEventTypes:
            return "The session contains newer event types that this Egakium version cannot update safely."
        case .incompleteEventHistory:
    ...
    public var recoverySuggestion: String? {
        ...
        case .lockTimedOut:
            return "Wait for the other operation to finish, or close the other Egakium process using this session, then retry."
        case .writerAlreadyActive:
        ...
        case .unsupportedEventTypes:
            return "Open this session with a compatible newer Egakium version before changing its settings."
        case .staleModelHistory:
