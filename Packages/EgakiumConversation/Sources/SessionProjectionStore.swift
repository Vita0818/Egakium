...
public enum SessionProjectionStoreError: Error, LocalizedError, Equatable, Sendable {
    ...
    public var errorDescription: String? {
        switch self {
        case .unknownEventTypes:
            return "This Egakium version cannot fully project one or more newer session events."
        case .invalidSettingsHistory:
        ...
        case .unsupportedSchemaVersion:
            return "The session projection uses an unsupported schema version and must be rebuilt by a compatible Egakium version."
        case .verificationFailed:
