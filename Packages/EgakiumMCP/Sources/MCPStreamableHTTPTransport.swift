...
/// Egakium-owned implementation of MCP Streamable HTTP 2025-11-25.
///
    ...
    NegotiatedProtocolVersionTransport
{
    ...
    #if canImport(EgakiumCurlTransport)
    ...
    init(
        ...
        queue.name = "egakium.mcp.http.url-session"
