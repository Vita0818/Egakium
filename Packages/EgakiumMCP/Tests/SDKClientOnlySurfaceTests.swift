...
final class SDKClientOnlySurfaceTests: XCTestCase {
    ...
    func testProductTargetLinkageKeepsIOSNoneAndAppStoreRemoteOnly() throws {
        ...
        XCTAssertTrue(developerID.contains("product: EgakiumMCP"))
        XCTAssertTrue(developerID.contains("product: EgakiumMCPStdio"))
        XCTAssertTrue(appStore.contains("product: EgakiumMCP"))
        XCTAssertFalse(appStore.contains("product: EgakiumMCPStdio"))
        XCTAssertFalse(iOS.contains("product: EgakiumMCP"))
        XCTAssertFalse(iOS.contains("product: EgakiumMCPStdio"))
    }
