...
///
/// Egakium remains Swift-native and does not execute npm packages. The package
    ...
    Sendable
{
    ...
    public static let siliconFlowV1 = ProviderRequestAdapter(
        rawValue: "egakium:siliconflow-v1")
    ...
    public static let cohereV2 = ProviderRequestAdapter(
        rawValue: "egakium:cohere-v2")

    /// Missing adapter fields in previously persisted Egakium values decode to
    ...
    public static let legacyOpenAIWire = ProviderRequestAdapter(
        rawValue: "egakium:legacy-openai-wire")
