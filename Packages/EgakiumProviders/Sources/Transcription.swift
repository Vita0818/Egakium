...
// OpenAICompatibleTranscriber pipeline. Egakium keeps only the single-model
...
private enum TranscriptionTemporaryFiles {
    static let inputPrefix = "Egakium-Transcription-Input-"
    static let bodyPrefix = "Egakium-Transcription-Body-"
...
private struct TranscriptionBodyFile {
    ...
    static func multipart(
        ...
        let boundary = "EgakiumBoundary-\(UUID().uuidString)"
