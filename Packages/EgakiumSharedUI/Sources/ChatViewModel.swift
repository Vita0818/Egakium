...
public final class ChatViewModel: ObservableObject {
    ...
    @Published public private(set) var draftAttachments: [EgakiumComposerDraftAttachment] = []
    ...
    public init(
        ...
        self.composerAttachmentStore = artifactStore.map {
            EgakiumComposerAttachmentStore(store: $0)
        }
        #if canImport(AVFoundation)
        ...
        let operation = Task { @MainActor [weak self] in
            ...
            for url in urls {
                ...
                do {
                    ...
                    guard !EgakiumCancellation.isCurrentTaskCancellation(error) else {
                        return
                    }
                    self.errorText = EgakiumLocalization.format(
    ...
    public func reportAttachmentImportFailure(_ error: Error) {
        ...
        errorText = EgakiumLocalization.format(
    ...
    public func generateImage() {
        ...
        guard let onGenerateImage else {
            let message = EgakiumLocalization.string("Image generation is not available.")
