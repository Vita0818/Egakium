...
// part of the Egakium composer integration.
...
private enum ComposerVoiceTemporaryFiles {
    static let audioPrefix = "Egakium-Audio-"
    private static let legacyAudioPrefix = "egakium-voice-input-"
...
public final class ComposerVoiceInputController: ObservableObject {
    ...
    public var buttonHelp: String {
        switch phase {
        case .idle:
            return EgakiumLocalization.string("Start voice input")
        case .requestingPermission:
            return EgakiumLocalization.string("Preparing voice input")
        case .recording:
            return EgakiumLocalization.string("Stop and transcribe")
        case .transcribing:
            return EgakiumLocalization.string("Transcribing voice input")
        }
    }
    ...
    private func publish(_ error: Error) {
        ...
        case ComposerVoiceInputFailure
                .transcriptionModelNotConfigured:
            errorText = EgakiumLocalization.string(
        ...
        case ComposerVoiceInputFailure.microphoneBusy,
            ...
            errorText = EgakiumLocalization.string(
                "The microphone is already being used by another Egakium session.")
