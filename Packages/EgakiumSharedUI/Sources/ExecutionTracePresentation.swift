...
public enum EgakiumExecutionTracePresentation {
    public static let launchArgument = "-EgakiumShowExecutionTrace"
    public static let environmentVariable = "EGAKIUM_SHOW_EXECUTION_TRACE"
