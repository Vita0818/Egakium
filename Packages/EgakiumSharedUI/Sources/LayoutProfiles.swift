...
public struct EgakiumSplitColumnLayout: Equatable {
    ...
    public static let chatInspector = EgakiumSplitColumnLayout(
        sidebarMin: 160,
        sidebarIdeal: 210,
        contentMin: 300,
        contentIdeal: 560,
    ...
    public static let workspace = EgakiumSplitColumnLayout(
        sidebarMin: 150,
        sidebarIdeal: 200,
        contentMin: 320,
        contentIdeal: 600,
...
public struct EgakiumWorkspaceInspectorLayout: Equatable {
...
public enum EgakiumWorkspaceInspectorLayoutPolicy {
    public static func resolve(
        ...
        guard isRequested,
            ...
            return EgakiumWorkspaceInspectorLayout(
                isVisible: false,
...
public enum EgakiumCoworkStatusRailLayoutPolicy {
...
public struct ThreeColumnShellLayout: Equatable {
    ...
    public var columns: EgakiumSplitColumnLayout

    public init(presentation: Presentation = .split,
                columns: EgakiumSplitColumnLayout = .chatInspector) {
