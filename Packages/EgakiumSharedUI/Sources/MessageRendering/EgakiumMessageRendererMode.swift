...
public enum EgakiumMessageRendererMode: String, CaseIterable, Sendable {
    case microsoft
    case plainSafe

    public static let defaultsKey = "egakium.messageRendering.mode.v1"
    public static let plainSafeLaunchArgument = "-EgakiumPlainSafeMessages"
    public static let microsoftLaunchArgument = "-EgakiumMicrosoftMarkdownMessages"
    public static let legacyRichLaunchArgument = "-EgakiumRichTextMessages"
...
public struct EgakiumMessageRenderPlan: Equatable, Sendable {
    ...
    public static func resolve(
        ...
        isComplete: Bool,
        policyIsRich: Bool,
        rendererMode: EgakiumMessageRendererMode
    ) -> Self {
