...
import Crypto
#else
#error("EgakiumKnowledge requires CryptoKit or swift-crypto")
#endif
import EgakiumCore
...
public enum KnowledgeContract {
    ...
    public static let profileSchema = "egakium-okf-rag-profile/0.1"
    public static let profileIdentity = "org.vita.egakium.okf-rag"
    public static let profileVersion = "0.1"
    public static let storeSchema = "egakium-rag-store/1"
    public static let chunkSchema = "egakium-chunk/1"
    public static let checksumsSchema = "egakium-rag-checksums/1"
    public static let validationSchema = "egakium-rag-validation/1"
    public static let evidenceContract = "egakium-evidence/1"
    public static let validatorIdentity = "org.vita.egakium.knowledge-validator"
    public static let validatorVersion = "1"
    public static let textNormalizationVersion = "egakium-text-normalization/1"
    public static let deterministicChunkerIdentity = "org.vita.egakium.heading-paragraph-window"
    public static let deterministicChunkerVersion = "1"
    public static let exactKNNBackendIdentity = "org.vita.egakium.exact-knn"
    public static let exactKNNFormatVersion = "float32-json/1"
    public static let exactKNNRuntimeVersion = "1"
    public static let lexicalBackendIdentity = "org.vita.egakium.bm25"
    ...
    public static let utf8SourceLocatorAdapterIdentity =
        "org.vita.egakium.utf8-byte-range"
...
public struct KnowledgeSourceLocator: Codable, Equatable, Hashable, Sendable {
    ...
    public init(schema: String = "egakium-source-locator/1",
                sourceID: String,
...
public struct KnowledgeDenseIndexFile: Codable, Equatable, Sendable {
    ...
    public init(dimensions: Int, vectors: [KnowledgeDenseVectorRecord]) {
        schema = "egakium-dense-exact-knn/1"
        self.dimensions = dimensions
