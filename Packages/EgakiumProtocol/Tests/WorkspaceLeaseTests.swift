...
final class WorkspaceLeaseTests: XCTestCase {
    ...
    func testWorkspaceLeaseBindsExistingDirectoryIdentityAndDetectsReplacement() throws {
        let parent = FileManager.default.temporaryDirectory
            .appendingPathComponent("egakium-lease-identity-\(UUID().uuidString)", isDirectory: true)
    ...
    func testWorkspaceLeaseExpressesRootAccessAndDeniedPatterns() {
        ...
        for required in [
            ...
            "**/.config/gh/**", "**/.config/egakium/**", "**/.git/config",
            ".egakium-rag-store.json", ".egakium-rag-snapshots",
            ".egakium-rag-host",
        ] {
            XCTAssertTrue(
