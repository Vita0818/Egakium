...
/// A host-coordinated mutation performed by a tool. Most operations append
/// events or change the Cowork roster/task graph; a specifically named host
/// bootstrap effect may also provision a deterministic workspace resource
/// without granting the acting agent general file-write authority.
public enum PermissionControlEffect: String, Codable, Equatable, Sendable, Hashable {
    ...
    case provisionCanvasElement = "provision_canvas_element"
