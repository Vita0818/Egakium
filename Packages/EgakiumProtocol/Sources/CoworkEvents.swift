...
public struct AgentSpawnRequestedPayload: Codable, Equatable, Sendable {
    ...
    public var model: ModelID?
    public var agentInferenceBinding: AgentInferenceBinding?
    /// Host-provisioned generic element planned by this exact spawn
    /// admission. This is resource provenance, not permanent Agent ownership.
    public var provisionedCanvasElement: SessionCanvasElementDescriptor?
    public var metadata: CoworkEventMetadata?
    ...
    public init(requestedBy: AgentID? = nil,
                ...
                model: ModelID? = nil,
                agentInferenceBinding: AgentInferenceBinding? = nil,
                provisionedCanvasElement: SessionCanvasElementDescriptor? = nil,
                metadata: CoworkEventMetadata? = nil) {
        ...
        self.model = model
        self.agentInferenceBinding = agentInferenceBinding
        self.provisionedCanvasElement = provisionedCanvasElement
        self.metadata = metadata
    }
}
...
public struct AgentSpawnedPayload: Codable, Equatable, Sendable {
    ...
    public var model: ModelID
    public var agentInferenceBinding: AgentInferenceBinding?
    /// The fresh generic element that was present before this spawn admission
    /// became durable. It remains governed by ordinary workspace/task leases.
    public var provisionedCanvasElement: SessionCanvasElementDescriptor?
    public var metadata: CoworkEventMetadata?
