# Egakium rbook helper

This is the fixed, separately built EPUB backend for `EgakiumTools`. It is not
...
- macOS: `~/Library/Application Support/Egakium/document-runtime/bin/egakium-rbook-helper`
- Linux: `~/.local/share/egakium/document-runtime/bin/egakium-rbook-helper`

Egakium only reads that optional user-managed runtime. It does not install or
...
versioned request is supplied through the two host-owned `EGAKIUM_DOCUMENT_*`
