...
enum DocumentPythonBackend {
    ...
    static func invocation(
        ...
        return DocumentBackendInvocation(
            ...
            environment: [
                "EGAKIUM_DOCUMENT_REQUEST": encoded,
                "EGAKIUM_DOCUMENT_OPERATION": operation,
                "PYTHONHASHSEED": "0",
            ],
    ...
    static func fixedOCRPayload(
        ...
        guard let runtime = egakiumDocumentRuntimeRoot() else {
...
def require_request():
    raw = os.environ.get('EGAKIUM_DOCUMENT_REQUEST')
    ...
    if os.environ.get('EGAKIUM_DOCUMENT_OPERATION') != value['operation']:
