...
public struct ContextBuilder: Sendable {
    ...
    public static func coworkSystemPrompt(name _: String,
                                          ...
                                          editableCanvasSessionID: SessionID? = nil) -> String {
        ...
        if (canCoordinate ?? (coordinationDepth > 0)),
           ...
           let relativePath = try? SessionCanvasStore.relativeIndexPath(
            ...
            You are the exact @main coordinator for an Ekagium Session that has a
            ...
            CSS, and JavaScript. Keep it a valid standalone HTML document. It may contain
            multiple nested semantic elements and may load additional local element
            documents with relative iframe URLs beneath the same Session Canvas directory.
