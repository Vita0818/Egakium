...
private func leaseTempLog() throws -> EventLog {
    let url = FileManager.default.temporaryDirectory
        .appendingPathComponent("egakium-lease-\(UUID().uuidString)", isDirectory: true)
...
final class ToolRegistryLeaseTests: XCTestCase {
    ...
    func testHostedSearchRequiresSeparateLeaseCapabilityAndBoundService() {
        ...
        XCTAssertEqual(hostedOnly.registryVersion, "egakium.cowork.v4")
        XCTAssertEqual(
    ...
    func testApplyPatchCapabilityRegistersBothConcreteEditToolsFromOneSource() throws {
        ...
        XCTAssertEqual(writeAuthorization.concreteToolID, "egakium.cowork.v4/write_file")
        XCTAssertEqual(patchAuthorization.concreteToolID, "egakium.cowork.v4/apply_patch")
    ...
    func testDocumentCapabilitiesRegisterOnlyTheirExactReplacementTools() {
        ...
        XCTAssertEqual(registry.registryVersion, "egakium.cowork.v4")
    ...
    func testAuthorizationSnapshotValidationFailsClosedForIdentityDrift() throws {
        ...
        let wrongRegistry = try replacing("registryVersion", with: "egakium.cowork.other")
        XCTAssertThrowsError(try registry.validateAuthorizationSnapshot(
            wrongRegistry,
            toolName: "write_file",
            normalizedArguments: arguments,
        ...
        let wrongConcreteTool = try replacing("concreteToolID", with: "egakium.cowork.v4/other")
        XCTAssertThrowsError(try registry.validateAuthorizationSnapshot(
            wrongConcreteTool,
            toolName: "write_file",
            normalizedArguments: arguments,
    ...
    func testWorkerTaskUpdateSchemaExposesOnlyBoundProgressAndSettlementFields() throws {
        ...
        XCTAssertEqual(workerRegistry.registryVersion, "egakium.cowork.v4")
        XCTAssertEqual(
    ...
    func testTaskLeasePreservesCoordinatorCapabilityAndPrompt() async throws {
        ...
        XCTAssertTrue(systemPrompt.contains("Inspect the bounded EGAKIUM_SKILL_CATALOG"))
