...
public actor PermissionReviewControlPlane {
    ...
    private static func isHostAgentAdmission(
        ...
        guard task.taskContract?.kind == .agentAdmission,
              ...
              task.gate.policyVersion == "egakium.workspace-admission.v1",
              task.replayPolicy
              ...
              authorization.registryVersion == "egakium.cowork.admission.v1",
              authorization.concreteToolID
                == "egakium.cowork.admission.v1/agent.attach",
    ...
    private static func systemPrompt(reviewer: Agent) -> String {
        """
        You are @\(reviewer.name.rawValue), the dedicated automatic permission reviewer for an Egakium Cowork session.
