...
public struct AgentLoop: Sendable {
    ...
    private static func turnInterruption(
        ...
        if EgakiumCancellation.isCurrentTaskCancellation(error) {
    ...
    private static func terminalErrorPayload(
        ...
        if EgakiumCancellation.isCancellationSignal(error) {
            return ErrorPayload(
                code: "runtime_failed",
    ...
    private func runTool(
        ...
        if preparedCall.executableCall == nil,
           ...
           field == AuthorizationSidecarCodec.reservedFieldName {
            ...
            let message =
                "authorization_context_mode_mismatch: __egakium_authorization_context is host-reserved for Cowork automatic review and is not a business tool argument in this mode"
    ...
    private static func uniquedToolCalls(
        ...
        calls.map { call in
            ...
            repeat {
                candidate = "call_egakium_\(syntheticOrdinal)"
                syntheticOrdinal += 1
    ...
    private static func sidecarFreeHistoryCall(
        ...
        return ToolCall(
            ...
            arguments: #"{"_egakium":"arguments_redacted"}"#,
    ...
    private static func authorizationSidecarFailureMessage(
        ...
        case .valid:
            return nil
        case .missing:
            return "authorization_context_missing: include the required __egakium_authorization_context string in this exact business tool call"
        case .malformed:
            return "authorization_context_malformed: regenerate this exact business tool call with one nonempty __egakium_authorization_context string"
        ...
        for call in toolCalls {
            ...
            case .valid(let canonical)
                ...
                if sanitized.redacted || sanitized.truncated {
                    durableArguments = #"{"_egakium":"arguments_redacted"}"#
                    argumentsRedacted = true
                } else {
    ...
    private func appendDurableToolCall(
        ...
        if forceRedaction || validatedArguments == nil {
            displayArguments = #"{"_egakium":"arguments_redacted"}"#
            redacted = true
    ...
    private static func gateSnapshot(_ result: GateResult) -> PermissionReviewGateSnapshot {
        ...
        case .deny(let reason, let risk):
            return PermissionReviewGateSnapshot(
                ...
                policyVersion: "egakium.deterministic-policy.v1")
