#!/usr/bin/env python3
"""Create an Egakium Agent Skill skeleton inside an explicitly selected root.

Modified by Egakium from the OpenAI Codex skill-creator sample; see
...
def main():
    parser = argparse.ArgumentParser(
        description="Create an Egakium Agent Skill skeleton."
    )
