...
Egakium uses Yams only inside the non-iOS `EgakiumKnowledge` target to parse
...
MIT licensed. Egakium does not copy Yams source into this repository; SwiftPM
...
Egakium applies its own pre-parse byte limits, rejects aliases and custom tags,
