...
Egakium adopts a byte-exact copy of the self-contained Open Knowledge Format
...
- Egakium-authored provenance and checksum records.
...
Egakium' OKF RAG Profile, validator, snapshot store, indexes, and tool
